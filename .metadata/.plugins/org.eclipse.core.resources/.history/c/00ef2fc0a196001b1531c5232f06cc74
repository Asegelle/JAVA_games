...
public class LauncherBatailleNavalle {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bienvenue dans le jeu de la Bataille Navale vs IA !\n\nLa bataille navale oppose deux joueurs qui s'affrontent. \nChacun a une flotte composée de 5 bateaux : \n\t1 porte-avion (5 cases), \n\t1 croiseur (4 cases), \n\t1 contre-torpilleur (3 cases), \n\t1 sous-marin (3 cases), \n\t1 torpilleur (2 cases). \nAu début du jeu, chaque joueur place ses bateaux sur sa grille. \nCelle-ci est numérotée de 1 à 10 verticalement et de A à J horizontalement. \nUn à un, les joueurs vont « tirer » sur une case de l'adversaire : par exemple, B3 ou encore H8. \nLe but est de couler les bateaux adverses, en ayant touché toutes les cases occupées par ces bateaux.\n");
		// boucle de relance du jeu
		do {
			boolean isVictory = false;
			// fonction pour renvoyer à J1 la grille initiale vide (tc)
			...
			// fonction pour interroger IA, déterminer position bateaux sur la grille (et renvoyer la grille)
...
//			System.out.println(firstPlayer);
			...
			do {
				...
				if (returnedIsIAB1Dead && returnedIsIAB2Dead && returnedIsIAB3Dead && returnedIsIAB4Dead && returnedIsIAB5Dead) {
					System.out.println("tous les bâteaux de la flotte de "+IA+" sont coulés !");
				...
				if (returnedIsP1B1Dead && returnedIsP1B2Dead && returnedIsP1B3Dead && returnedIsP1B4Dead && returnedIsP1B5Dead) {
					System.out.println("tous les bâteaux de la flotte de "+PLAYER1+" sont coulés !");
